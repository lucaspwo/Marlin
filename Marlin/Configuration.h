...
#define STRING_CONFIG_H_AUTHOR "Lucas Oliveira, Anet A8 v24.04" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Pretinha"
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  #define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  22.20 }
    #define DEFAULT_Ki_LIST {   1.08 }
    #define DEFAULT_Kd_LIST { 114.00 }
  #else
    #define DEFAULT_Kp  48.13
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 535.19
  #define DEFAULT_bedKi 82.70
  #define DEFAULT_bedKd 865.88
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -34, -3, -0.4 }
